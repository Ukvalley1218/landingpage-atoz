        ...
        <div className='overflow-x-hidden'>
            ...
            <section className="w-full bg-white lg:min-h-screen flex flex-col">
             ...
             hover:from-[#1B497A] hover:to-[#123050] hover:shadow-lg hover:scale-105"
                ...
                {/* Hero Section */}
                <div className="w-full bg-[url('/books/atoz/images/bg.png')] bg-cover bg-center overflow-hidden">
               ...
               hover:scale-105 transition-transform shadow-lg"
                        ...
                        >
                            <div className="relative">
                                <img loading="lazy"
                                    src="/books/atoz/images/coverpage.webp"
                                    alt="Dubai Real Estate Book"
                                    className="w-[300px] sm:w-[280px] md:w-[350px] lg:w-[500px] xl:w-[625px] drop-shadow-2xl z-10"
                                />

                                {/* Floating Images */}
                                <img loading="lazy"
                                    src="/books/atoz/images/tr.png"
                                    alt=""
                                    className="hidden lg:block absolute top-[-18px] right-[-38px] w-[100px] xl:w-[191px] rotate-3 z-20"
                                />
                                <img loading="lazy"
                                    src="/books/atoz/images/bl.png"
                                    alt=""
                                    className="hidden lg:block absolute bottom-[29px] left-[-129px] w-[110px] xl:w-[191px] -rotate-2 z-20"
                                />
                                <img loading="lazy"
                                    src="/books/atoz/images/br.png"
                                    alt=""
                                    className="hidden lg:block absolute bottom-[55px] right-[-74px] w-[110px] xl:w-[191px] rotate-6 z-20"
                                />
                            </div>
                        </motion.div>
                    </div>
            ...
            <div id='about-book' className=" grid md:grid-cols-2 gap-8 md:gap-10 lg:gap-12 items-center mb-0 mt-0 md:mb-12 md:mt-12 lg:mb-0 lg:mt-0">
                ...
                <div className="pt-12 md:pt-0 lg:pt-0 relative flex items-center justify-center md:justify-end lg:justify-start lg:pl-8">
                    ...
                    <div className=" relative w-full max-w-[480px] md:max-w-[520px] lg:max-w-[597px] h-[320px] md:h-[500px] lg:h-[700px]">
                        ...
                        >
                            <img loading="lazy"
                                src="/books/atoz/images/cover2.png"
                                alt="The A to Z of Dubai Real Estate Book Cover"
                                className="w-[250px] sm:w-[320px] md:w-[320px] lg:w-[429px] h-auto object-contain"
                                style={{ transform: 'rotate(-2.849deg)' }}
                            />
                        </motion.div>
                    </div>
                </div>
                        ...
                        >
                            ...
                            >
                                <p>
                                    ...
                                    <span className="font-bold bg-clip-text text-transparent bg-gradient-to-t from-[#FFE08A] to-[#FFD700]">
                                        Through <span className="font-nunito">1XL</span> Infra
                                    </span>
                            ...
                            <div className="flex flex-wrap justify-center items-center gap-4 sm:gap-6 lg:gap-11 mt-6 sm:mt-8 lg:mt-10">
                                <center className="flex flex-wrap justify-center gap-5 max-w-[200px] sm:max-w-none">
                                    ...
                                    <a
                                        href="https://www.linkedin.com/company/MamataJainXL/"
                                    ...
                                    <a
                                        href="https://www.facebook.com/MamataJainXL/"
                                    ...
                                    <a
                                        href="https://www.youtube.com/@MamataJainXL"
                                    ...
                                    <a
                                        href="https://www.threads.com/@MamataJainXL"
                                        className="relative group w-8 h-8 bg-black rounded flex items-center justify-center hover:scale-110 transition-transform"
                                        aria-label="THREADS"
                                        target='blank'
                                    >
                                    ...
                                    {/* <a
                                        href="https://www.quora.com/profile/MamataJainXL"
                                    ...
                                    <a
                                        href="https://www.pinterest.com/MamataJainXL/"
            ...
            < section className="bg-white text-white py-12 md:py-14 lg:py-20 px-6" >
                <div className="max-w-6xl mx-auto bg-[#123050] rounded-lg shadow-lg p-8 md:p-12 relative">
                    {/* Title */}
                    <h2 className="text-center font-coustard text-xl md:text-3xl mb-4">
                        What You Will Learn In
                    </h2>
                    <h3 className="text-center font-coustard text-xl md:text-4xl font-black mb-4 md:mb-12 lg:mb-12">
                    ...
                    <div className="grid md:grid-cols-2 gap-8 items-start">
                        ...
                        <div className="flex justify-center items-start">
                            <img loading="lazy"
                                src="/books/atoz/images/coverpage.png"
                                alt="Dubai Real Estate Book"
                                className="w-52 md:w-60 lg:w-64 mt-[5px] lg:mt-[-5px] mb-10 lg:mb-0 drop-shadow-xl"
                            />
                        </div>
                    </div>
                ...
                <div  className="lg:min-h-screen xl:-mt-7 bg-gradient-to-br from-[#DCDCDC] to-[#E6E6E6] px-4 md:px-6 lg:px-8 flex items-center justify-center py-0 md:pb-4 lg:py-5 xl:py-12">
                    <div className="max-w-6xl w-full">
                        ...
                        <div className="relative text-center mb-4 md:mb-0 lg:mb-32">
                            <h2 className="font-coustard text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-[#123050] mb-0 md:mb-0 lg:mb-4 px-4">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-8 items-start">
                            ...
                            <div className="flex justify-center  items-center order-first lg:order-none md:my-0 lg:my-0">
                                <div className="relative">
                                    <img loading="lazy"
                                        src="/books/atoz/images/Book Mockups.gif"
                                        alt="Book animation"
                                        className="w-56 md:w-96 lg:w-auto mt-[-4px] md:mt-0 lg:mt-[-78px]"
                                    />
                                </div>
                            </div>
                    ...
                    <div className="max-w-6xl w-full bg-gradient-to-b from-[#123050] to-[#1B497A] from-0% to-100% p-6 sm:p-8 md:p-10 lg:p-12 rounded-lg md:rounded-xl">
                        ...
                        <div className="text-center mb-8 sm:mb-10 lg:mb-12">
                            <h2 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold text-white mb-2 px-2 leading-tight">
                                Why <span className="font-coustard">The A to Z of Dubai Real Estate Book</span> Stands Out?
                            </h2>
                        </div>
                        ...
                        <div className="flex flex-col lg:flex-row lg:gap-20 items-start lg:mt-[-14px]">
                            ...
                            <div className="flex-shrink-0 w-full lg:w-80 flex justify-center lg:justify-start">
                                <div className="relative w-56 sm:w-64 md:w-72 lg:w-full">
                                    {/* Book mockup */}
                                    <div className="relative z-10 lg:mt-[-50px]">
                                        <img loading="lazy"
                                            src="/books/atoz/images/cover3.webp"
            ...
            <div className="lg:min-h-screen bg-gradient-to-br from-slate-200 via-slate-300 to-slate-200 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-12 md:py-14">
                <div className="max-w-7xl w-full">
                    <h3 className="text-3xl sm:text-4xl md:text-5xl lg:text-5xl font-coustard font-black text-center text-slate-800 mb-8 sm:mb-12 md:mb-14 lg:mb-16 px-4">
                        Testimonials
                    </h3>
            ...
            <div className="lg:min-h-screen flex items-center justify-center p-4 py-12 md:py-0 lg:py-0">
                <div className="max-w-7xl w-full bg-gradient-to-b from-[#123050] to-[#1B497A] rounded-[10px] shadow-2xl overflow-hidden px-4 sm:px-6 md:px-10 lg:px-16 py-10 sm:py-14 md:py-16 lg:py-20">
                    ...
                    <div className="w-full text-left mb-8 sm:mb-4 md:mb-4">
                        <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-coustard leading-tight text-white max-w-5xl mx-auto lg:mx-0">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-10 items-center relative">
                        ...
                        <div className="relative hidden lg:flex items-center justify-center lg:justify-end">
                            <img loading="lazy"
                                src="/books/atoz/images/Group.png"
                                alt="Front Book"
            ...
            <div id='faqs' className="lg:min-h-screen bg-gradient-to-b from-[#123050] to-[#1B497A] from-0% to-100% py-12 sm:py-14 md:py-16 lg:py-20 px-4 sm:px-6 lg:px-8">
                <div className="max-w-5xl mx-auto">
                    {/* Header */}
                    <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-[45px] font-coustard font-bold text-white text-center mb-8 sm:mb-10 md:mb-12 lg:mb-14 px-2 leading-tight">
...
>
                            ...
                            <div className="flex flex-nowrap gap-2 pb-2">
                                <a
                                    href="https://www.instagram.com/MamataJainXL/"
                                    className="relative group w-8 h-8 bg-gradient-to-br from-purple-600 via-pink-600 to-orange-500 rounded flex items-center justify-center hover:scale-110 transition-transform"
                                    aria-label="Instagram"
                                    target='blank'
                                >
